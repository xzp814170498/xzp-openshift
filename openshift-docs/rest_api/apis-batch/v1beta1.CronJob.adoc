...
</div></details><details open><summary><span title="(v1beta1.CronJobSpec) Specification of the desired behavior of a cron job, including the schedule. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status">spec</span>:
</summary><div style="margin-left:13px;">  <span title="(string) Specifies how to treat concurrent executions of a Job. Valid values are: - &#34;Allow&#34; (default): allows CronJobs to run concurrently; - &#34;Forbid&#34;: forbids concurrent runs, skipping next run if previous run hasn&#39;t finished yet; - &#34;Replace&#34;: cancels currently running job and replaces it with a new one">concurrencyPolicy</span>:
</div><div style="margin-left:13px;">  <span title="(integer) The number of failed finished jobs to retain. This is a pointer to distinguish between explicit zero and not specified. Defaults to 1.">failedJobsHistoryLimit</span>:
</div><details><summary>  <span title="(v1beta1.JobTemplateSpec) Specifies the job that will be created when executing a CronJob.">jobTemplate</span>:
...
</div><div style="margin-left:13px;">  <span title="(integer) The number of successful finished jobs to retain. This is a pointer to distinguish between explicit zero and not specified. Defaults to 3.">successfulJobsHistoryLimit</span>:
...
</div></details><details><summary><span title="(v1beta1.CronJobStatus) Current status of a cron job. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status">status</span>:
...
[[Post-apis-batch-v1beta1-cronjobs]]
=== Create a CronJob
Create a CronJob

==== HTTP request
----
POST /apis/batch/v1beta1/cronjobs HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/batch/v1beta1/cronjobs <<'EOF'
{
  "kind": "CronJob",
  "apiVersion": "batch/v1beta1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.CronJob
|201 Created|v1beta1.CronJob
|202 Accepted|v1beta1.CronJob
|401 Unauthorized|
|===
...
==== HTTP request
----
POST /apis/batch/v1beta1/namespaces/$NAMESPACE/cronjobs HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/batch/v1beta1/namespaces/$NAMESPACE/cronjobs <<'EOF'
{
  "kind": "CronJob",
  "apiVersion": "batch/v1beta1",
  ...
...
==== HTTP request
----
GET /apis/batch/v1beta1/namespaces/$NAMESPACE/cronjobs/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/batch/v1beta1/namespaces/$NAMESPACE/cronjobs/$NAME
----
...
==== HTTP request
----
GET /apis/batch/v1beta1/cronjobs HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/batch/v1beta1/cronjobs
----
...
==== HTTP request
----
GET /apis/batch/v1beta1/namespaces/$NAMESPACE/cronjobs HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/batch/v1beta1/namespaces/$NAMESPACE/cronjobs
----
...
=== Watch a CronJob in a namespace
Watch changes to an object of kind CronJob

==== HTTP request
----
GET /apis/batch/v1beta1/watch/namespaces/$NAMESPACE/cronjobs/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/batch/v1beta1/watch/namespaces/$NAMESPACE/cronjobs/$NAME
----
...
==== HTTP request
----
GET /apis/batch/v1beta1/watch/cronjobs HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/batch/v1beta1/watch/cronjobs
----
...
==== HTTP request
----
GET /apis/batch/v1beta1/watch/namespaces/$NAMESPACE/cronjobs HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/batch/v1beta1/watch/namespaces/$NAMESPACE/cronjobs
----
...
==== HTTP request
----
PUT /apis/batch/v1beta1/namespaces/$NAMESPACE/cronjobs/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/batch/v1beta1/namespaces/$NAMESPACE/cronjobs/$NAME <<'EOF'
{
  "kind": "CronJob",
  "apiVersion": "batch/v1beta1",
  ...
...
==== HTTP request
----
PATCH /apis/batch/v1beta1/namespaces/$NAMESPACE/cronjobs/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/batch/v1beta1/namespaces/$NAMESPACE/cronjobs/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/batch/v1beta1/namespaces/$NAMESPACE/cronjobs HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
==== HTTP request
----
GET /apis/batch/v1beta1/namespaces/$NAMESPACE/cronjobs/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/batch/v1beta1/namespaces/$NAMESPACE/cronjobs/$NAME/status
----
...
==== HTTP request
----
PUT /apis/batch/v1beta1/namespaces/$NAMESPACE/cronjobs/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/batch/v1beta1/namespaces/$NAMESPACE/cronjobs/$NAME/status <<'EOF'
{
  "kind": "CronJob",
  "apiVersion": "batch/v1beta1",
  ...
...
==== HTTP request
----
PATCH /apis/batch/v1beta1/namespaces/$NAMESPACE/cronjobs/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json-patch+json'
