...
$ curl -k \
    ...
    https://$ENDPOINT/apis/policy/v1beta1/podsecuritypolicies <<'EOF'
{
  "kind": "PodSecurityPolicy",
  "apiVersion": "policy/v1beta1",
  ...
...
==== HTTP request
----
GET /apis/policy/v1beta1/podsecuritypolicies/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/policy/v1beta1/podsecuritypolicies/$NAME
----
...
==== HTTP request
----
GET /apis/policy/v1beta1/podsecuritypolicies HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/policy/v1beta1/podsecuritypolicies
----
...
==== HTTP request
----
GET /apis/policy/v1beta1/watch/podsecuritypolicies/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/policy/v1beta1/watch/podsecuritypolicies/$NAME
----
...
==== HTTP request
----
GET /apis/policy/v1beta1/watch/podsecuritypolicies HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/policy/v1beta1/watch/podsecuritypolicies
----
...
==== HTTP request
----
PUT /apis/policy/v1beta1/podsecuritypolicies/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/policy/v1beta1/podsecuritypolicies/$NAME <<'EOF'
{
  "kind": "PodSecurityPolicy",
  "apiVersion": "policy/v1beta1",
  ...
...
==== HTTP request
----
PATCH /apis/policy/v1beta1/podsecuritypolicies/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/policy/v1beta1/podsecuritypolicies/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/policy/v1beta1/podsecuritypolicies HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
