...
</div><div style="margin-left:13px;"><span title="(integer) Deprecated field assuring backward compatibility with core.v1 Event type">deprecatedCount</span>:
</div><div style="margin-left:13px;"><span title="(v1.Time) Deprecated field assuring backward compatibility with core.v1 Event type">deprecatedFirstTimestamp</span>:
</div><div style="margin-left:13px;"><span title="(v1.Time) Deprecated field assuring backward compatibility with core.v1 Event type">deprecatedLastTimestamp</span>:
</div><details><summary><span title="(v1.EventSource) Deprecated field assuring backward compatibility with core.v1 Event type">deprecatedSource</span>:
...
</div></details><div style="margin-left:13px;"><span title="(v1.MicroTime) Required. Time when this Event was first observed.">eventTime</span>:
...
</div></details><div style="margin-left:13px;"><span title="(string) Optional. A human-readable description of the status of this operation. Maximal length of the note is 1kB, but libraries should be prepared to handle values up to 64kB.">note</span>:
</div><div style="margin-left:13px;"><span title="(string) Why the action was taken.">reason</span>:
</div><details><summary><span title="(v1.ObjectReference) The object this Event is about. In most cases it&#39;s an Object reporting controller implements. E.g. ReplicaSetController implements ReplicaSets and this event is emitted because it acts on some changes in a ReplicaSet object.">regarding</span>:
</summary><div style="margin-left:13px;">  <span title="(string) API version of the referent.">apiVersion</span>:
...
</div></details><details><summary><span title="(v1.ObjectReference) Optional secondary object for more complex actions. E.g. when regarding object triggers a creation or deletion of related object.">related</span>:
</summary><div style="margin-left:13px;">  <span title="(string) API version of the referent.">apiVersion</span>:
</div><div style="margin-left:13px;">  <span title="(string) If referring to a piece of an object instead of an entire object, this string should contain a valid JSON/Go field access statement, such as desiredState.manifest.containers[2]. For example, if the object reference is to a container within a pod, this would take on a value like: &#34;spec.containers{name}&#34; (where &#34;name&#34; refers to the name of the container that triggered the event) or if no container name is specified &#34;spec.containers[2]&#34; (container with index 2 in this pod). This syntax is chosen only to have some well-defined way of referencing a part of an object.">fieldPath</span>:
</div><div style="margin-left:13px;">  <span title="(string) Kind of the referent. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds">kind</span>:
</div><div style="margin-left:13px;">  <span title="(string) Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names">name</span>:
...
</div></details><div style="margin-left:13px;"><span title="(string) Name of the controller that emitted this Event, e.g. `kubernetes.io/kubelet`.">reportingController</span>:
</div><div style="margin-left:13px;"><span title="(string) ID of the controller instance, e.g. `kubelet-xyzf`.">reportingInstance</span>:
</div><details><summary><span title="(v1beta1.EventSeries) Data about the Event series this event represents or nil if it&#39;s a singleton Event.">series</span>:
...
</div><div style="margin-left:13px;">  <span title="(v1.MicroTime) Time when last Event from the series was seen before last heartbeat.">lastObservedTime</span>:
</div><div style="margin-left:13px;">  <span title="(string) Information whether this series is ongoing or finished.">state</span>:
...
[[Post-apis-events.k8s.io-v1beta1-events]]
=== Create a Event
Create an Event

==== HTTP request
----
POST /apis/events.k8s.io/v1beta1/events HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/events.k8s.io/v1beta1/events <<'EOF'
{
  "kind": "Event",
  "apiVersion": "events.k8s.io/v1beta1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.Event
|201 Created|v1beta1.Event
|202 Accepted|v1beta1.Event
|401 Unauthorized|
|===
...
==== HTTP request
----
POST /apis/events.k8s.io/v1beta1/namespaces/$NAMESPACE/events HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/events.k8s.io/v1beta1/namespaces/$NAMESPACE/events <<'EOF'
{
  "kind": "Event",
  "apiVersion": "events.k8s.io/v1beta1",
  ...
...
==== HTTP request
----
GET /apis/events.k8s.io/v1beta1/namespaces/$NAMESPACE/events/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/events.k8s.io/v1beta1/namespaces/$NAMESPACE/events/$NAME
----
...
==== HTTP request
----
GET /apis/events.k8s.io/v1beta1/events HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/events.k8s.io/v1beta1/events
----
...
==== HTTP request
----
GET /apis/events.k8s.io/v1beta1/namespaces/$NAMESPACE/events HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/events.k8s.io/v1beta1/namespaces/$NAMESPACE/events
----
...
==== HTTP request
----
GET /apis/events.k8s.io/v1beta1/watch/namespaces/$NAMESPACE/events/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/events.k8s.io/v1beta1/watch/namespaces/$NAMESPACE/events/$NAME
----
...
==== HTTP request
----
GET /apis/events.k8s.io/v1beta1/watch/events HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/events.k8s.io/v1beta1/watch/events
----
...
==== HTTP request
----
GET /apis/events.k8s.io/v1beta1/watch/namespaces/$NAMESPACE/events HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/events.k8s.io/v1beta1/watch/namespaces/$NAMESPACE/events
----
...
==== HTTP request
----
PUT /apis/events.k8s.io/v1beta1/namespaces/$NAMESPACE/events/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/events.k8s.io/v1beta1/namespaces/$NAMESPACE/events/$NAME <<'EOF'
{
  "kind": "Event",
  "apiVersion": "events.k8s.io/v1beta1",
  ...
...
==== HTTP request
----
PATCH /apis/events.k8s.io/v1beta1/namespaces/$NAMESPACE/events/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/events.k8s.io/v1beta1/namespaces/$NAMESPACE/events/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/events.k8s.io/v1beta1/namespaces/$NAMESPACE/events HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
