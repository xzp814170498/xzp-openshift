...
==== HTTP request
----
POST /apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations <<'EOF'
{
  "kind": "MutatingWebhookConfiguration",
  "apiVersion": "admissionregistration.k8s.io/v1beta1",
  ...
...
|===
|Parameter|Schema
|body|v1beta1.MutatingWebhookConfiguration
|===
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.MutatingWebhookConfiguration
|201 Created|v1beta1.MutatingWebhookConfiguration
|202 Accepted|v1beta1.MutatingWebhookConfiguration
|401 Unauthorized|
|===
...
=== Get a MutatingWebhookConfiguration
Read the specified MutatingWebhookConfiguration

==== HTTP request
----
GET /apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/$NAME
----
...
==== HTTP request
----
GET /apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations
----
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.MutatingWebhookConfigurationList
|401 Unauthorized|
|===
...
=== Watch a MutatingWebhookConfiguration
Watch changes to an object of kind MutatingWebhookConfiguration

==== HTTP request
----
GET /apis/admissionregistration.k8s.io/v1beta1/watch/mutatingwebhookconfigurations/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/admissionregistration.k8s.io/v1beta1/watch/mutatingwebhookconfigurations/$NAME
----
...
=== Watch all MutatingWebhookConfigurations
Watch individual changes to a list of MutatingWebhookConfiguration

==== HTTP request
----
GET /apis/admissionregistration.k8s.io/v1beta1/watch/mutatingwebhookconfigurations HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/admissionregistration.k8s.io/v1beta1/watch/mutatingwebhookconfigurations
----
...
==== HTTP request
----
PUT /apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/$NAME <<'EOF'
{
  "kind": "MutatingWebhookConfiguration",
  "apiVersion": "admissionregistration.k8s.io/v1beta1",
  ...
...
=== Patch a MutatingWebhookConfiguration
Partially update the specified MutatingWebhookConfiguration

==== HTTP request
----
PATCH /apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
=== Delete all MutatingWebhookConfigurations
Delete collection of MutatingWebhookConfiguration

==== HTTP request
----
DELETE /apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
