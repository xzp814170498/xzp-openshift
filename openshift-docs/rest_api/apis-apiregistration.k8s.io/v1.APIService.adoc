...
</div></details><details open><summary><span title="(v1.APIServiceSpec) Spec contains information for locating and communicating with a server">spec</span>:
...
</div></details><details><summary><span title="(v1.APIServiceStatus) Status contains derived information about an API server">status</span>:
...
==== HTTP request
----
POST /apis/apiregistration.k8s.io/v1/apiservices HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/apiregistration.k8s.io/v1/apiservices <<'EOF'
{
  "kind": "APIService",
  "apiVersion": "apiregistration.k8s.io/v1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1.APIService
|201 Created|v1.APIService
|202 Accepted|v1.APIService
|401 Unauthorized|
|===
...
==== HTTP request
----
GET /apis/apiregistration.k8s.io/v1/apiservices/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apiregistration.k8s.io/v1/apiservices/$NAME
----
...
==== HTTP request
----
GET /apis/apiregistration.k8s.io/v1/apiservices HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apiregistration.k8s.io/v1/apiservices
----
...
==== HTTP request
----
GET /apis/apiregistration.k8s.io/v1/watch/apiservices/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apiregistration.k8s.io/v1/watch/apiservices/$NAME
----
...
==== HTTP request
----
GET /apis/apiregistration.k8s.io/v1/watch/apiservices HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apiregistration.k8s.io/v1/watch/apiservices
----
...
==== HTTP request
----
PUT /apis/apiregistration.k8s.io/v1/apiservices/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apiregistration.k8s.io/v1/apiservices/$NAME <<'EOF'
{
  "kind": "APIService",
  "apiVersion": "apiregistration.k8s.io/v1",
  ...
...
==== HTTP request
----
PATCH /apis/apiregistration.k8s.io/v1/apiservices/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/apiregistration.k8s.io/v1/apiservices/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/apiregistration.k8s.io/v1/apiservices HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
==== HTTP request
----
PUT /apis/apiregistration.k8s.io/v1/apiservices/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apiregistration.k8s.io/v1/apiservices/$NAME/status <<'EOF'
{
  "kind": "APIService",
  "apiVersion": "apiregistration.k8s.io/v1",
  ...
