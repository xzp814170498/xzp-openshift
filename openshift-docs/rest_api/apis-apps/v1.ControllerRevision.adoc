...
[[Post-apis-apps-v1-controllerrevisions]]
=== Create a ControllerRevision
Create a ControllerRevision

==== HTTP request
----
POST /apis/apps/v1/controllerrevisions HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/apps/v1/controllerrevisions <<'EOF'
{
  "kind": "ControllerRevision",
  "apiVersion": "apps/v1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1.ControllerRevision
|201 Created|v1.ControllerRevision
|202 Accepted|v1.ControllerRevision
|401 Unauthorized|
|===
...
==== HTTP request
----
POST /apis/apps/v1/namespaces/$NAMESPACE/controllerrevisions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/controllerrevisions <<'EOF'
{
  "kind": "ControllerRevision",
  "apiVersion": "apps/v1",
  ...
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/controllerrevisions/$NAME
----
...
==== HTTP request
----
GET /apis/apps/v1/controllerrevisions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/controllerrevisions
----
...
|===
|HTTP Code|Schema
|200 OK|v1.ControllerRevisionList
|401 Unauthorized|
|===
...
==== HTTP request
----
GET /apis/apps/v1/namespaces/$NAMESPACE/controllerrevisions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/controllerrevisions
----
...
==== HTTP request
----
GET /apis/apps/v1/watch/namespaces/$NAMESPACE/controllerrevisions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/watch/namespaces/$NAMESPACE/controllerrevisions/$NAME
----
...
==== HTTP request
----
GET /apis/apps/v1/watch/controllerrevisions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/watch/controllerrevisions
----
...
==== HTTP request
----
GET /apis/apps/v1/watch/namespaces/$NAMESPACE/controllerrevisions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/watch/namespaces/$NAMESPACE/controllerrevisions
----
...
==== HTTP request
----
PUT /apis/apps/v1/namespaces/$NAMESPACE/controllerrevisions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/controllerrevisions/$NAME <<'EOF'
{
  "kind": "ControllerRevision",
  "apiVersion": "apps/v1",
  ...
...
==== HTTP request
----
PATCH /apis/apps/v1/namespaces/$NAMESPACE/controllerrevisions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/apps/v1/namespaces/$NAMESPACE/controllerrevisions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/apps/v1/namespaces/$NAMESPACE/controllerrevisions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
