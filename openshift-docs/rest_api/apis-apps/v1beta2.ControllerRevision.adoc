...
[[Post-apis-apps-v1beta2-controllerrevisions]]
=== Create a ControllerRevision
Create a ControllerRevision

==== HTTP request
----
POST /apis/apps/v1beta2/controllerrevisions HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/apps/v1beta2/controllerrevisions <<'EOF'
{
  "kind": "ControllerRevision",
  "apiVersion": "apps/v1beta2",
  ...
...
|===
|Parameter|Schema
|body|v1beta2.ControllerRevision
|===
...
==== HTTP request
----
POST /apis/apps/v1beta2/namespaces/$NAMESPACE/controllerrevisions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/controllerrevisions <<'EOF'
{
  "kind": "ControllerRevision",
  "apiVersion": "apps/v1beta2",
  ...
...
==== HTTP request
----
GET /apis/apps/v1beta2/namespaces/$NAMESPACE/controllerrevisions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/controllerrevisions/$NAME
----
...
==== HTTP request
----
GET /apis/apps/v1beta2/controllerrevisions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/controllerrevisions
----
...
|===
|HTTP Code|Schema
|200 OK|v1beta2.ControllerRevisionList
|401 Unauthorized|
|===
...
==== HTTP request
----
GET /apis/apps/v1beta2/namespaces/$NAMESPACE/controllerrevisions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/controllerrevisions
----
...
==== HTTP request
----
GET /apis/apps/v1beta2/watch/namespaces/$NAMESPACE/controllerrevisions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/watch/namespaces/$NAMESPACE/controllerrevisions/$NAME
----
...
==== HTTP request
----
GET /apis/apps/v1beta2/watch/controllerrevisions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/watch/controllerrevisions
----
...
==== HTTP request
----
GET /apis/apps/v1beta2/watch/namespaces/$NAMESPACE/controllerrevisions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/watch/namespaces/$NAMESPACE/controllerrevisions
----
...
==== HTTP request
----
PUT /apis/apps/v1beta2/namespaces/$NAMESPACE/controllerrevisions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/controllerrevisions/$NAME <<'EOF'
{
  "kind": "ControllerRevision",
  "apiVersion": "apps/v1beta2",
  ...
...
==== HTTP request
----
PATCH /apis/apps/v1beta2/namespaces/$NAMESPACE/controllerrevisions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/apps/v1beta2/namespaces/$NAMESPACE/controllerrevisions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/apps/v1beta2/namespaces/$NAMESPACE/controllerrevisions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
