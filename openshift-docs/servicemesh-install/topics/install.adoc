...
|The default value is `v0.14.0` if `deployment_type=origin`.

 The default value is `0.14.0` if `deployment_type=openshift`.
|===
...
You can find the https://github.com/Maistra/openshift-ansible/tree/maistra-0.8/istio[operator templates on GitHub].
