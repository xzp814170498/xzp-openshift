...
== Overview
This topic reviews how to configure link:https://azure.microsoft.com/en-us/services/storage/blobs/[Microsoft Azure Blob Storage] for xref:../../install_config/registry/deploy_registry_existing_clusters.adoc#deploy-registry[OpenShift integrated container image registry].
...
* xref:../../install_config/registry/deploy_registry_existing_clusters.adoc#deploy-registry[Deploy the integrated container image registry] if it is not deployed.
