...
[id='priority-preemption-configuring_{context}']
= Configuring priority and preemption
...
. Create pods or edit existing pods to include the name of a priority class. You can add the priority name directly to the pod configuration or to a pod template:
