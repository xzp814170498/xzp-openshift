...
以及安装Ansible 2.6或更高版本。您必须安装Ansible运行安装剧本。
...
您可以在云环境中提供{product-title}VM。您可以使用Ansible剧本自动化云托管基础设施的定义，
...
和
link:https://github.com/openshift/openshift-ansible/tree/master/playbooks/openstack[Ansible剧本]
来自动化它们。请参见
